...
if menu == 'Приклад використання':
  ...
  st.write('Приклд введених даних:')
  st.code("""
  ...
  Назва: 2  Гель для прання Polar Shine Marseille з марсельським милом, 125 циклів прання, 5 л;
      Бренд: Polar Shine;
      Ключові інгредієнти: 5-15% аніонні ПАР, &lt 5% хлорид натрію, запашник, піногасник, метилхлорізотіазолінон та метилізотіазолінон, барвник.
      Опис:ЗВЕРНІТЬ УВАГУ! Товар має пошкоджене паковання.Ефективне очищення та дбайливий догляд за тканинними виробами   завдяки унікальному поєднанню універсального порошку з мінеральним пінним активатором у ньому.
      ...
      Активні компоненти засобу помякшують воду, утворюючи мяку піну, яка швидко розчиняється у воді та повноцінно усуває навіть найдрібніші плями, зокрема ті, які викликають небажаний запах.
      """, language='text')
  ...
  checkpoint_path = "/content/drive/MyDrive/project/results/checkpoint-45000"
